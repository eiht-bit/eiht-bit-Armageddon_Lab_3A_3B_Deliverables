...
locals {
  ...
  # liberdade_zone_id = var.manage_route53_in_terraform ? aws_route53_zone.liberdade_zone01[0].zone_id : "", so may duplicates after these damn bonuses.
...
# resource "aws_acm_certificate_validation" "liberdade_acm_validation01_dns" {
